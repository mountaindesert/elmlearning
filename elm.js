...
var _mountaindesert$elmlearning$Main$hideRow = _elm_lang$core$Native_List.fromArray(
	[
		...
		_mountaindesert$elmlearning$Main$transition('opacity 500ms, top 1000ms')
	]);
...
var _mountaindesert$elmlearning$Main$editPlayer = F2(
...
var _mountaindesert$elmlearning$Main$score = function (model) {
	var _p3 = _elm_lang$core$List$head(model.plays);
	if (_p3.ctor === 'Just') {
		var newPlays = A2(
			_elm_lang$core$List$map,
			function (p) {
				return _elm_lang$core$Native_Utils.eq(p.id, _p3._0.id) ? _elm_lang$core$Native_Utils.update(
					p,
					{hidden: false}) : p;
			},
			model.plays);
...
var _mountaindesert$elmlearning$Main$hidePlayer = F2(
	function (model, player) {
		var newPlayers = A2(
			_elm_lang$core$List$map,
			function (p) {
				return _elm_lang$core$Native_Utils.eq(p.playerId, player.playerId) ? _elm_lang$core$Native_Utils.update(
					player,
					{hidden: true, points: 0}) : p;
			},
			model.players);
		var newPlays = A2(
			_elm_lang$core$List$filter,
...
var _mountaindesert$elmlearning$Main$init = {
	ctor: '_Tuple2',
	_0: {
...
var _mountaindesert$elmlearning$Main$Player = F4(
	function (a, b, c, d) {
		return {playerId: a, playerName: b, points: c, hidden: d};
	});
var _mountaindesert$elmlearning$Main$createPlayer = function (model) {
	var player = A4(
...
var _mountaindesert$elmlearning$Main$addPlayer = function (model) {
	var player = A4(
		_mountaindesert$elmlearning$Main$Player,
		_elm_lang$core$List$length(model.players),
		model.playerName,
...
var _mountaindesert$elmlearning$Main$save = function (model) {
	...
	if (_p4.ctor === 'Just') {
		return A2(_mountaindesert$elmlearning$Main$editPlayer, model, _p4._0);
	} else {
		return _mountaindesert$elmlearning$Main$addPlayer(model);
	}
};
var _mountaindesert$elmlearning$Main$Play = F5(
	function (a, b, c, d, e) {
		return {id: a, playerId: b, playerName: c, points: d, hidden: e};
	});
var _mountaindesert$elmlearning$Main$preparePlay = F3(
...
var _mountaindesert$elmlearning$Main$NoOp = {ctor: 'NoOp'};
var _mountaindesert$elmlearning$Main$DeletePlayer = function (a) {
	return {ctor: 'DeletePlayer', _0: a};
};
var _mountaindesert$elmlearning$Main$HidePlayer = function (a) {
	return {ctor: 'HidePlayer', _0: a};
};
...
var _mountaindesert$elmlearning$Main$play = function (play) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				play.hidden ? _mountaindesert$elmlearning$Main$styles(_mountaindesert$elmlearning$Main$hideRow) : _mountaindesert$elmlearning$Main$styles(_mountaindesert$elmlearning$Main$rowStyles)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
...
var _mountaindesert$elmlearning$Main$Score = {ctor: 'Score'};
	...
	function (msg, model) {
		...
		switch (_p5.ctor) {
			...
			case 'HidePlayer':
				...
				return {
					ctor: '_Tuple2',
					_0: A2(_mountaindesert$elmlearning$Main$hidePlayer, model, _p8),
					_1: A3(
						_elm_lang$core$Task$perform,
						function (_p6) {
							return _mountaindesert$elmlearning$Main$NoOp;
						},
						function (_p7) {
							return _mountaindesert$elmlearning$Main$DeletePlayer(_p8);
						},
			...
			case 'DeletePlayer':
				return {
					ctor: '_Tuple2',
					_0: A2(_mountaindesert$elmlearning$Main$deletePlayer, model, _p5._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Edit':
				var _p9 = _p5._0;
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							playerName: _p9.playerName,
							playerId: _elm_lang$core$Maybe$Just(_p9.playerId)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Save':
				return _elm_lang$core$String$isEmpty(model.playerName) ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
					ctor: '_Tuple2',
					_0: _mountaindesert$elmlearning$Main$save(model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PrepPlay':
				return {
					ctor: '_Tuple2',
					_0: A3(_mountaindesert$elmlearning$Main$preparePlay, model, _p5._0, _p5._1),
					_1: A3(
						_elm_lang$core$Task$perform,
						function (_p10) {
							return _mountaindesert$elmlearning$Main$NoOp;
						...
						function (_p11) {
							return _mountaindesert$elmlearning$Main$Score;
						},
						_elm_lang$core$Process$sleep(500 * _elm_lang$core$Time$millisecond))
				};
			case 'Score':
				return {
					ctor: '_Tuple2',
					_0: _mountaindesert$elmlearning$Main$score(model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'HidePlay':
				var _p14 = _p5._0;
				return {
					ctor: '_Tuple2',
					_0: A2(_mountaindesert$elmlearning$Main$hidePlay, model, _p14),
					_1: A3(
						_elm_lang$core$Task$perform,
						function (_p12) {
							return _mountaindesert$elmlearning$Main$NoOp;
						...
						function (_p13) {
							return _mountaindesert$elmlearning$Main$DeletePlay(_p14);
						},
						_elm_lang$core$Process$sleep(500 * _elm_lang$core$Time$millisecond))
				};
			case 'DeletePlay':
				return {
					ctor: '_Tuple2',
					_0: A2(_mountaindesert$elmlearning$Main$deletePlay, model, _p5._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _mountaindesert$elmlearning$Main$PrepPlay = F2(
	function (a, b) {
		return {ctor: 'PrepPlay', _0: a, _1: b};
	});
...
var _mountaindesert$elmlearning$Main$player = F2(
	function (editPlayerId, player) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					player.hidden ? _mountaindesert$elmlearning$Main$styles(_mountaindesert$elmlearning$Main$hideRow) : _mountaindesert$elmlearning$Main$styles(_mountaindesert$elmlearning$Main$rowStyles)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onMouseDown(
							_mountaindesert$elmlearning$Main$HidePlayer(player))
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$type$('button'),
									_elm_lang$html$Html_Events$onMouseDown(
									A2(_mountaindesert$elmlearning$Main$PrepPlay, player, 1)),
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$type$('button'),
									_elm_lang$html$Html_Events$onMouseDown(
									A2(_mountaindesert$elmlearning$Main$PrepPlay, player, 2)),
									_elm_lang$html$Html_Attributes$class('btn btn-default btn-xs')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$type$('button'),
									_elm_lang$html$Html_Events$onMouseDown(
									A2(_mountaindesert$elmlearning$Main$PrepPlay, player, 3)),
									_elm_lang$html$Html_Attributes$class('btn btn-default btn-xs')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
...
var _mountaindesert$elmlearning$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _mountaindesert$elmlearning$Main$init, view: _mountaindesert$elmlearning$Main$view, update: _mountaindesert$elmlearning$Main$update, subscriptions: _mountaindesert$elmlearning$Main$subscriptions})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _mountaindesert$elmlearning$Main$main === 'undefined' ? null : _mountaindesert$elmlearning$Main$main);
